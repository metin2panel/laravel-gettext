...
namespace Depiedra\LaravelGettext\Config\Models;
...
class Config
{
    ...
    {
        return $this->localeLabels[$locale] ?? null;
    }
     ...
     * @return array
     */
    public function getLocaleEnglishLabels()
    {
        return $this->localeEnglishLabels;
    }

    /**
     * @param array $localeEnglishLabels
     *
     * @return $this
     */
    public function setLocaleEnglishLabels($localeEnglishLabels)
    {
        $this->localeEnglishLabels = $localeEnglishLabels;
     ...
     * @return string|null
     */
    public function getLocaleEnglishLabel($locale)
    {
        return $this->localeEnglishLabels[$locale] ?? null;
    }
    ...
    {
        $this->sourcePaths = array_merge($this->sourcePaths, $sourcePaths);
    ...
    {
        if (! in_array($handler, ['symfony', 'gettext', 'default',])) {
